...
def main_kb():
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text='🎯 Миссии', callback_data='missions'), InlineKeyboardButton(text='🏅 Достижения', callback_data='achievements')],
        [InlineKeyboardButton(text='👤 Профиль', callback_data='profile'), InlineKeyboardButton(text='🔔 Уведомления', callback_data='notifications')],
        [InlineKeyboardButton(text='🎟 Промокод', callback_data='promo'), InlineKeyboardButton(text='🌐 Язык', callback_data='language')],
...
def tasks_kb(task_id: int, completed: bool, url: str):
    ...
    rows.append([InlineKeyboardButton(text='⬅️ Назад', callback_data='tasks')])
